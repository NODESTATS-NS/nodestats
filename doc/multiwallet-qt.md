...
In order to support loading of multiple wallets in nodestats-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nodestats.cpp.
...
Changes to nodestats.cpp
----------------------
nodestats.cpp is the entry point into nodestats-qt, and as such, will require some minor modifications to provide hooks for
