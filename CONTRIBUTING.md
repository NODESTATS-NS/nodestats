Contributing to Nodestats
============================

The Nodestats project operates an open contributor model where anyone is
...
The following applies to code changes to the Nodestats project, and is not to be
confused with overall Nodestats Network Protocol consensus changes.

Whether a pull request is merged into Nodestats rests with the project merge
...
Where a patch set proposes to change the Nodestats consensus, it must have been
...
The project leader is the release manager for each Nodestats release.
