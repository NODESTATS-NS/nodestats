Contributing to Nodestats Core
============================

The Nodestats Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Nodestats Core project, and is not to be
confused with overall Nodestats Network Protocol consensus changes.

Whether a pull request is merged into Nodestats Core rests with the project merge
...
Patches that change Nodestats consensus rules are considerably more involved than
...
Where a patchset proposes to change the Nodestats consensus, it must have been
...
The project leader is the release manager for each Nodestats Core release.
