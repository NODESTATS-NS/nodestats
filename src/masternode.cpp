...
CAmount CMasternode::GetMasternodeNodeCollateral(int nHeight) 
{
    ...
    if (nHeight >   750000) return    80000 * COIN;
    if (nHeight >   500000) return    70000 * COIN;
    if (nHeight >   400000) return    60000 * COIN;
    if (nHeight >   300000) return    50000 * COIN;
    if (nHeight >   250000) return    45000 * COIN;
    if (nHeight >   225000) return    40000 * COIN;
    if (nHeight >   200000) return    35000 * COIN;
    if (nHeight >   175000) return    30000 * COIN;
    if (nHeight >   150000) return    26000 * COIN;
    if (nHeight >   130000) return    24000 * COIN;
    if (nHeight >   110000) return    22000 * COIN;
    if (nHeight >    90000) return    20000 * COIN;
    if (nHeight >    70000) return    18000 * COIN;
    if (nHeight >    50000) return    16000 * COIN;
    if (nHeight >    30000) return    14000 * COIN;
    if (nHeight >    10000) return    12000 * COIN;
...
{
    if (nHeight >   1000000) return        2.5 * COIN;
    if (nHeight >    750000) return         5 * COIN;
    if (nHeight >    685001) return       10 * COIN;
    if (nHeight >    685000) return       15 * COIN;
    if (nHeight >    500000) return       10 * COIN;
    if (nHeight >    400000) return       20 * COIN;
    if (nHeight >    300000) return       40 * COIN;
    if (nHeight >    250000) return       80 * COIN;
    if (nHeight >    225000) return       75 * COIN;
	if (nHeight >    200000) return       70 * COIN;
    if (nHeight >    175000) return       65 * COIN;
    if (nHeight >    150000) return       60 * COIN;
    if (nHeight >    130000) return       55 * COIN;
    if (nHeight >    110000) return       50 * COIN;
    if (nHeight >     90000) return       45 * COIN;
    if (nHeight >     70000) return       40 * COIN;
    if (nHeight >     50000) return       35 * COIN;
    if (nHeight >     30000) return       30 * COIN;
    if (nHeight >     10000) return       25 * COIN;
    if (nHeight >         250) return     22.5 * COIN;
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 1000 NS tx got MASTERNODE_MIN_CONFIRMATIONS
    uint256 hashBlock = UINT256_ZERO;
    CTransaction tx2;
    GetTransaction(vin.prevout.hash, tx2, hashBlock, true);
    BlockMap::iterator mi = mapBlockIndex.find(hashBlock);
    if (mi != mapBlockIndex.end() && (*mi).second) {
        CBlockIndex* pMNIndex = (*mi).second;                                                        // block for 1000 NS tx -> 1 confirmation
