...
const char * const PIVX_CONF_FILENAME = "nodestats.conf";
const char * const PIVX_PID_FILENAME = "ns.pid";
...
static fs::path ZC_GetBaseParamsDir()
{
    ...
    // Mac: ~/Library/Application Support/nsParams
    // Unix: ~/.ns-params
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "NodestatsParams";
#else
    fs::path pathRet;
    char* pszHome = getenv("HOME");
    if (pszHome == NULL || strlen(pszHome) == 0)
    ...
    pathRet /= "Library/Application Support";
    TryCreateDirectory(pathRet);
    return pathRet / "NodestatsParams";
#else
    // Unix
    return pathRet / ".ns-params";
#endif
#endif
}
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        ...
        if (configFile != NULL) {
	        ...
	        strHeader += "\nrpcport=22441\naddnode=136.243.77.62:22440\naddnode=[2a01:4f8:212:2b15::157]:22440\naddnode=[2a01:4f8:212:2b15::158]:22440\n";
