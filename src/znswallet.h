...
#ifndef Nodestats_ZNSWALLET_H
#define Nodestats_ZNSWALLET_H
...
public:
    CznsWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZNS(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZNS(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //Nodestats_ZNSWALLET_H
