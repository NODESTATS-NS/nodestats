...
/* Nodestats GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Nodestats"
#define QAPP_ORG_DOMAIN "nodestats.online"
#define QAPP_APP_NAME_DEFAULT "Nodestats-Qt"
#define QAPP_APP_NAME_TESTNET "Nodestats-Qt-testnet"
