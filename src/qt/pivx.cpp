...
/** Class encapsulating Nodestats Core startup and shutdown.
...
{
    QMessageBox::critical(0, "Runaway exception", QObject::tr("A fatal error occurred. Nodestats can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(1);
}
...
/// 2. Basic Qt initialization (not dependent on parameters or configuration)
    ...
    // ns: links repeatedly have their payment requests routed to this process:
