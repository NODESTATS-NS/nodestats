...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Nodestats nodestats-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nodestats-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nodestats transaction") + "\n" +
                               "  nodestats-tx [options] -create [commands]   " + _("Create hex-encoded nodestats transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nodestats transaction
