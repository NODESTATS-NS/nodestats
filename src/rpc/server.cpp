...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Nodestats server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Nodestats server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Nodestats features */
        {"nodestats", "masternode", &masternode, true, true, false},
        {"nodestats", "listmasternodes", &listmasternodes, true, true, false},
        {"nodestats", "getmasternodecount", &getmasternodecount, true, true, false},
        {"nodestats", "masternodeconnect", &masternodeconnect, true, true, false},
        {"nodestats", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"nodestats", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"nodestats", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"nodestats", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nodestats", "masternodedebug", &masternodedebug, true, true, false},
        {"nodestats", "startmasternode", &startmasternode, true, true, false},
        {"nodestats", "createmasternodekey", &createmasternodekey, true, true, false},
        {"nodestats", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nodestats", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"nodestats", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"nodestats", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"nodestats", "getmasternodescores", &getmasternodescores, true, true, false},
        {"nodestats", "mnbudget", &mnbudget, true, true, false},
        {"nodestats", "preparebudget", &preparebudget, true, true, false},
        {"nodestats", "submitbudget", &submitbudget, true, true, false},
        {"nodestats", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"nodestats", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"nodestats", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"nodestats", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"nodestats", "getbudgetinfo", &getbudgetinfo, true, true, false},
...
{
    return "> nodestats-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:22441/\n";
}
