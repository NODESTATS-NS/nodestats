...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NS features */
        {"ns", "listmasternodes", &listmasternodes, true },
        {"ns", "getmasternodecount", &getmasternodecount, true },
        {"ns", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"ns", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"ns", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"ns", "masternodecurrent", &masternodecurrent, true },
        {"ns", "startmasternode", &startmasternode, true },
        {"ns", "createmasternodekey", &createmasternodekey, true },
        {"ns", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"ns", "listmasternodeconf", &listmasternodeconf, true },
        {"ns", "getmasternodestatus", &getmasternodestatus, true },
        {"ns", "getmasternodewinners", &getmasternodewinners, true },
        {"ns", "getmasternodescores", &getmasternodescores, true },
        {"ns", "preparebudget", &preparebudget, true },
        {"ns", "submitbudget", &submitbudget, true },
        {"ns", "mnbudgetvote", &mnbudgetvote, true },
        {"ns", "getbudgetvotes", &getbudgetvotes, true },
        {"ns", "getnextsuperblock", &getnextsuperblock, true },
        {"ns", "getbudgetprojection", &getbudgetprojection, true },
        {"ns", "getbudgetinfo", &getbudgetinfo, true },
        {"ns", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"ns", "mnfinalbudget", &mnfinalbudget, true },
        {"ns", "checkbudgets", &checkbudgets, true },
        {"ns", "mnsync", &mnsync, true },
        {"ns", "spork", &spork, true },
