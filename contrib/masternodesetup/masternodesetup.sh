...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='nodestats.conf'
CONFIGFOLDER='/root/.nodestats'
COIN_DAEMON='nsd'
COIN_CLI='ns-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/TeamNodestats/nodestats/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
