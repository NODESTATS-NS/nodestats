...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/nodestats-cli.cpp \
           src/nodestats-tx.cpp \
           src/nodestats.cpp \
           src/db.cpp \
           ...
           src/qt/nodestats.cpp \
           src/qt/nodestatsstrings.cpp \
...
RESOURCES += src/qt/nodestats.qrc src/qt/nodestats_locale.qrc

TRANSLATIONS += src/qt/locale/nodestats_bg.ts \
                src/qt/locale/nodestats_de.ts \
                src/qt/locale/nodestats_en.ts \
                src/qt/locale/nodestats_es.ts \
                src/qt/locale/nodestats_fi.ts \
                src/qt/locale/nodestats_fr.ts \
                src/qt/locale/nodestats_it.ts \
                src/qt/locale/nodestats_ja.ts \
                src/qt/locale/nodestats_pl.ts \
                src/qt/locale/nodestats_pt.ts \
                src/qt/locale/nodestats_ru.ts \
                src/qt/locale/nodestats_sk.ts \
                src/qt/locale/nodestats_sv.ts \
                src/qt/locale/nodestats_vi.ts \
                src/qt/locale/nodestats_zh_CN.ts \
                src/qt/locale/nodestats_zh_TW.ts
