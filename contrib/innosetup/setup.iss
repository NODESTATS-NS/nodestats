...
#define MyAppName "Nodestats Core"
#define MyAppPublisher "2018-2023 The NodeStats developers"
#define MyAppURL "https://github.com/TeamNodestats/nodestats"
#define MyAppExeName "ns-qt.exe"
#define MyAppExtraData "https://github.com/TeamNodestats/nodestats/releases/download/v2.0/bootstrap.zip"
...
DefaultDirName={autopf}\Nodestats
...
OutputDir=.\output
OutputBaseFilename=NodestatsSetup
...
DefaultGroupName=Nodestats Core
...
[Files]
Source: ".\package\ns-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Nodestats\Nodestats-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Nodestats\Nodestats-Qt,strDataDir|{userappdata}\Nodestats\}');
  Result := True;
end;
