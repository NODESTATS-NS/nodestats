...
* Fill in the following data:
    * Application Name: `Nodestats Core`
    * Application Version: `2.0.0.0`
    * Application Publisher: `2018-2023 The NodeStats developers`
    * Application Website: `https://nodestats.net/`
* Setup the destination folder:
    * Program Files Folder
    * Folder name: `Nodestats`
* Add application files:
    * Select the file `ns-qt.exe` as main executable from the `package` folder
...
* Compiler settings
    ...
    * Edit the output base filename to: `ns-2.0.0-win64-setup.exe`
