...
#   c) node1 mines 32 blocks, so now node 0 has 60001NS, node 1 has 4250NS, node2 has none.
#   d) node0 sends 601 NS to node2, in two transactions (301 NS, then 300 NS).
